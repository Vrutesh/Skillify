...
<p>In conclusion, a frontend development assessment is a multifaceted evaluation that goes beyond coding skills. It assesses a candidate's understanding of fundamental concepts, proficiency in using relevant technologies, problem-solving abilities, and collaboration skills—all of which are essential for creating effective and engaging user interfaces in the rapidly evolving landscape of web development.</p>
            ...
            <section className="structure-container" id="test-structure">
             ...
             <div className="phase-1 phases">
              <h1>Round 1 - Aptitude Round</h1>
              <p className="round-1-info">Test your Frontend Development smarts with our multiple-choice aptitude round – pick the right code, showcase your problem-solving finesse, and let your skills shine as you unravel challenges designed to elevate your coding expertise !</p>
              <div className="skill-container">
                <h3>Topics -</h3>
                <Button variant="contained" sx={{color:"white" }}>HTML5</Button>
                <Button variant="contained" sx={{color:"white"}}>CSS3</Button>
                <Button variant="contained" sx={{color:"white"}}>Javascript</Button>
                <Button variant="contained" sx={{color:"white"}}>React JS</Button>
              </div>
              <div className="round-1-conditions">
              <p> ● Score more than 20 marks out of 25 to qualify for the next round.</p>
              <small>Total marks - 25</small>
              <h6>Aptitude</h6>
              </div>
             </div>
